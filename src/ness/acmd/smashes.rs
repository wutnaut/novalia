...
unsafe extern "C" fn skullkid_effect_attackhi4(agent: &mut L2CAgentBase) {
    ...
    if color == 6 || color == 7 {
        ...
        if macros::is_excute(agent) {
            macros::EFFECT(agent, Hash40::new("mewtwo_pk_attack_a"), Hash40::new("top"), 0, 9, 0, 0, 0, 0, 0.6, 0, 0, 0, 0, 0, 0, true);
            macros::EFFECT_FOLLOW(agent, Hash40::new("mewtwo_pk_attack_c"), Hash40::new("top"), 0, 15, 0, -90, 0, 0, 0.65, true);
        }
        frame(agent.lua_state_agent, 27.0);
        if macros::is_excute(agent) {
            macros::EFFECT(agent, Hash40::new("sys_damage_purple"), Hash40::new("top"), 0, 1, 7, 0, 0, 0, 0.75, 0, 0, 0, 0, 0, 0, true);
            macros::EFFECT(agent, Hash40::new("sys_damage_purple"), Hash40::new("top"), 0, 1, -7, 0, 0, 0, 0.75, 0, 0, 0, 0, 0, 0, true);
        }
        frame(agent.lua_state_agent, 30.0);
        if macros::is_excute(agent) {
