...
// GRABS
unsafe extern "C" fn skullkid_game_catch(agent: &mut L2CAgentBase) {
    ...
    if color == 6 || color == 7 {
        ...
        if macros::is_excute(agent) {
            macros::CATCH(agent, 0, Hash40::new("top"), 4.2, 0.0, 5.2, 2.5, Some(0.0), Some(5.2), Some(9.7), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
        }
        ...
        macros::FT_MOTION_RATE(agent, 1.0);
        if macros::is_excute(agent) {
            macros::CATCH(agent, 0, Hash40::new("top"), 4.2, 0.0, 5.2, 0.0, Some(0.0), Some(5.2), Some(9.7), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
        }
        //macros::game_CaptureCutCommon(agent);
        wait(lua_state, 2.0);
        if macros::is_excute(agent) {
...
unsafe extern "C" fn skullkid_game_catchdash(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.module_accessor;
    let color = WorkModule::get_int(agent.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_COLOR);
    if color == 6 || color == 7 {
        ...
        frame(lua_state, 9.0);
        if macros::is_excute(agent) {
            macros::CATCH(agent, 0, Hash40::new("top"), 4.2, 0.0, 5.2, 3.1, Some(0.0), Some(5.2), Some(12.4), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
        }
        macros::game_CaptureCutCommon(agent);
        wait(lua_state, 2.0);
        if macros::is_excute(agent) {
        ...
        frame(lua_state, 9.0);
        if macros::is_excute(agent) {
            macros::CATCH(agent, 0, Hash40::new("top"), 4.2, 0.0, 5.2, 0.0, Some(0.0), Some(5.2), Some(12.4), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
        }
        macros::game_CaptureCutCommon(agent);
        wait(lua_state, 2.0);
        if macros::is_excute(agent) {
...
unsafe extern "C" fn skullkid_game_catchturn(agent: &mut L2CAgentBase) {
    let lua_state = agent.lua_state_agent;
    let boma = agent.module_accessor;
    let color = WorkModule::get_int(agent.module_accessor, *FIGHTER_INSTANCE_WORK_ID_INT_COLOR);
    if color == 6 || color == 7 {
        ...
        if macros::is_excute(agent) {
            macros::CATCH(agent, 0, Hash40::new("top"), 4.2, 0.0, 5.2, 0.0, Some(0.0), Some(5.2), Some(-12.0), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
        }
        macros::game_CaptureCutCommon(agent);
        wait(lua_state, 2.0);
        if macros::is_excute(agent) {
        ...
        frame(lua_state, 10.0);
        if macros::is_excute(agent) {
            macros::CATCH(agent, 0, Hash40::new("top"), 4.2, 0.0, 5.2, 0.0, Some(0.0), Some(5.2), Some(-16.0), *FIGHTER_STATUS_KIND_CAPTURE_PULLED, *COLLISION_SITUATION_MASK_GA);
        }
        macros::game_CaptureCutCommon(agent);
        wait(lua_state, 2.0);
        if macros::is_excute(agent) {
...
unsafe extern "C" fn skullkid_game_throwf(agent: &mut L2CAgentBase) {
    ...
    if color == 6 || color == 7 {
        if macros::is_excute(agent) {
            macros::ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, 0, 11.0, 45, 15, 0, 110, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_purple"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
            macros::ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_CATCH, 0, 3.0, 361, 90, 0, 60, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
        }
...
unsafe extern "C" fn skullkid_game_throwb(agent: &mut L2CAgentBase) {
    ...
    if color == 6 || color == 7 {
        if macros::is_excute(agent) {
            macros::ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_THROW, 0, 11.0, 135, 75, 0, 45, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_purple"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
            macros::ATTACK_ABS(agent, *FIGHTER_ATTACK_ABSOLUTE_KIND_CATCH, 0, 3.0, 361, 100, 0, 60, 0.0, 1.0, *ATTACK_LR_CHECK_F, 0.0, true, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_NONE, *ATTACK_REGION_THROW);
        }
        frame(lua_state, 26.0);
        if macros::is_excute(agent) {
...
pub fn install() {
    Agent::new("ness")
        ...
        .game_acmd("game_catch", skullkid_game_catch, Default)
        .game_acmd("game_catchdash", skullkid_game_catchdash, Default)
        .game_acmd("game_catchturn", skullkid_game_catchturn, Default)
        .install();
}